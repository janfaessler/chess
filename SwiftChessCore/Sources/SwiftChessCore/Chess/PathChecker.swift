...
struct PathChecker {
    ...
    func firstPieceOnPath(from: Square, to: Square) -> (any ChessPiece)? {
    ...
    private func checkRow(from: Square, to: Square) -> (any ChessPiece)? {
    ...
    private func checkFile(from: Square, to: Square) -> (any ChessPiece)? {
    ...
    private func checkDiagonal(from: Square, to: Square) -> (any ChessPiece)? {
