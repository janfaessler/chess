...
#Preview {
    ...
    OpenPgnView(model: NavigationManagerModel(gameDataRepo: SwiftDataGameCollectionRepository(modelContext: container.mainContext), fileRepo: PgnFilesRepository()))
}
